          ...
          <Container className="" style={{backgroundColor:'#FAC102', position:'absolute', marginTop:'0px', height:'675px', width:'1152px'}} fluid>
            ...
            <div style={{backgroundColor:'#FFFFFF', position:'absolute', left:'0%', top:'0%', height:'81px', width:'229px', color:'#FB1242', fontFamily:'Gilroy', fontWeight:'bold', fontSize:'16px'}}>
              <div style={{marginLeft:'61px', marginTop:'27px'}}>
                <Image className="mb-1 mr-3" src={appLogo} height="28px" width="28px" alt="logo"/>#AboutTime
              </div>
            </div>
            <div>
              <Image className="" src={redlineIcon} style={{position:'absolute', marginTop:'40px', marginLeft:'190px'}} height="2px" width="90px" alt="logo"/>
            </div>
            ...
            <div style={{backgroundColor:'', position:'absolute', marginTop:'137px', marginLeft:'120px', height:'356px', width:'416px'}}>
              <p className="" style={{ fontSize:'14px', fontWeight:'600', fontFamily:'Gilroy', color:'#4F4F4F'}}><Image className="mb-1 mr-2" src={locationLogo} height="21px" width="15px" alt="logo"/>Everywhere</p>
              <p className="" style={{ fontSize:'45px', fontWeight:'bold', fontFamily:'Gilroy', color:'#333333'}}>Best Organic food, delivery food</p>
              <p className="" style={{ fontSize:'16px', fontWeight:'500', fontFamily:'Gilroy', color:'#333333'}}>Time-definite and day definite delivery based on your location.</p>
          ...
          <Container style={{position:'absolute', marginTop:'1234px', marginLeft:'119px', height:'428px', width:'894px', color:'#4F4F4F'}} fluid>
            ...
            <div style={{backgroundColor:'', position:'absolute', marginTop:'170px', height:'258px', width:'100%'}}>
              <div style={{position:'absolute', marginLeft:'0px', height:'100%', width:"268px"}}>
                ...
                <p style={{position:'absolute', fontWeight:'500', fontFamily:'gilroy', fontSize:'10px', color:'#828282', marginLeft:'3px', marginTop:'238px', zIndex:'3'}}>3, Ayo dele street Lagos.</p>
              </div>
