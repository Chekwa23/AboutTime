        ...
        <div style={{position:'absolute', height:'700px', width:'1152px', top:'50%', left:'50%', transform:'translate(-50%, -50%)'}}>
          <Container style={{position:'absolute', backgroundColor:'#FFFFFF', position:'absolute', marginLeft:'0px', marginTop:'0px', height:'100%', width:'50%'}}>
              <div style={{position:'absolute',  backgroundColor:'blue', marginLeft:'119px', marginTop:'40px', width:'378px'}}>
                  ...
                  <p style={{position:'absolute', marginLeft:'0px', marginTop:'89px', fontFamily:'gilroy', fontWeight:'bold', color:'#4F4F4F', fontSize:'24px'}}>Sign up, it’s free!</p>
                  <p style={{position:'absolute', marginLeft:'0px', marginTop:'131px', fontFamily:'gilroy', fontWeight:'500', color:'#828282', fontSize:'18px'}}>Create a new registed account</p>
                  <Form style={{position:'absolute', marginLeft:'0px', marginTop:'182px', width:'378px'}}>
                      ...
                      <Form.Group controlId="formBasicPassword" style={{position:'absolute', marginLeft:'0px', marginTop:'228px', width:'378px'}}>
                          <Form.Label style={{fontFamily:'gilroy', fontWeight:'600', color:'#828282', fontSize:'18px'}}>Confirm Password</Form.Label>
                          <Form.Control size="lg" type="password" placeholder="Enter your password" />
                      </Form.Group>
                      <Form.Group style={{position:'absolute', marginLeft:'0px', marginTop:'342px'}}>
                          <Button className="" style={signUpBtn} variant="danger">Sign up</Button>
                      </Form.Group>
                  </Form>
              </div>
          </Container>
          <Container style={{position:'absolute', backgroundColor:'#FAC102', position:'absolute', marginLeft:'50%', marginTop:'0px', height:'100%', width:'50%'}}>
              <p style={{position:'absolute', marginLeft:'296px', marginTop:'34px', fontFamily:'gilroy', fontWeight:'600', color:'#828282', fontSize:'16px'}}>Already have an accont? <span><Link style={{textDecoration:'none', color:'#FB1242'}} to={{pathname:'./signInPage', state:{}}}>Sign In</Link></span></p>
